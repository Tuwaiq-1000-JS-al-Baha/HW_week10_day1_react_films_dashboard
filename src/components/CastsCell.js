...
import CastDeleteModal from "./CastsDeleteModal"
import CastViewModal from "./CastsViewModale"
...
function CastCell(props) {
  ...
  return (
    <tr style={{ verticalAlign: "middle", tableLayout: "fixed", wordWrap: "break-word" }}>
      ...
      <td>{cast.lastName}</td>
      <td style={{ verticalAlign: "middle", tableLayout: "fixed", wordWrap: "break-word" }}>{cast.description}</td>
      <td>
