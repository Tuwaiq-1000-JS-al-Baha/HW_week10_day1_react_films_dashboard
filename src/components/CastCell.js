...
import CastDeleteModal from "./CastDeleteModel"
...
function CastCell(props) {
  ...
  const [deleteShow, setDeleteShow] = useState(false)
    ...
    return (  <tr style={{ verticalAlign: "middle", tableLayout: "fixed", wordWrap: "break-word" }}>
    ...
    <td>
      ...
      <CastViewModel show={viewShow} setShow={setViewShow} cast={cast} />
